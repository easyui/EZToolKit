...
#ifndef EZSerializeMacro_h
#define EZSerializeMacro_h


#endif /* EZSerializeMacro_h */
 ...
 *  EZSerializeKit在运行时对类以及所有层级父类的变量进行遍历，避免遗漏。属性越多，优势越明显。
 *
 * Usage:
 *
 * Person.h:
 ...
 *  EZSERIALIZE_DESCRIPTION();//(NOT NECESSARY)
 *
 *	@end
 * ========================================
 *
...
#define EZSERIALIZE_CODER_DECODER()     \
\
...
#define EZSERIALIZE_COPY_WITH_ZONE()  \
\
...
#define EZSERIALIZE_DESCRIPTION() \
\
...
/* 封装归档keyedArchiver操作 */
#define EZSERIALIZE_ARCHIVE(__objToBeArchived__, __key__, __filePath__)    \
\
...
#define EZSERIALIZE_UNARCHIVE(__objToStoreData__, __key__, __filePath__)   \
